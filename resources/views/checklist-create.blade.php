...
<div class="flex flex-col justify-evenly items-center w-full h-full">
    ...
    <div class="h-1/4 w-4/5 flex flex-col items-center">
        ...
        <form class="w-full" method="post" action="/checklist">
            ...
            <button class="w-full flex flex-row justify-center shadow-custom-grey shadow-md rounded-2xl p-5 m-5 text-5xl hover:cursor-pointer" type="submit">{{ $template->name }}</button>
        </form>
        @endforeach
    </div>
